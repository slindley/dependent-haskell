...
We present a generic low-level GUI library based on \emph{boxes},
which represent rectangular chunks of two-dimensional space.
...
Vectors are applicative functors, foldable and traversable.
...
> 
> renderCharBox :: Size w h -> CharBox PRIME(w, h) -> CharMatrix PRIME(w, h)
