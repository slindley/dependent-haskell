...
joinH (x1, y1) (x2, y2) b1 b2 =
  case cmp y1 y2 of
    LTNat n' -> Hor x1 (Ver y1 b1 (Sy n') (clear (x1, Sy n'))) x2 b2
    EQNat    -> Hor x1 b1 x2 b2
    GTNat n' -> Hor x1 b1 x2 (Ver y2 b2 (Sy n') (clear (x2, Sy n')))
...
joinV (x1, y1) (x2, y2) b1 b2 =
  case cmp x1 x2 of
    LTNat n' -> Ver y1 (Hor x1 b1 (Sy n') (clear (Sy n', y1))) y2 b2
    EQNat    -> Ver y1 b1 y2 b2
    GTNat n' -> Ver y1 b1 y2 (Hor x2 b2 (Sy n') (clear (Sy n', y2)))
